...
You can enable two-factor authentication from your user page, either by linking an [authenticator application](#authenticator) or a security key that is compatible with [WebAuthn](https://webauthn.guide/) to your user profile.
...
##### To enable two-factor authentication using an authenticator application
...
<div class="section-steps" markdown="1">
##### To enable two-factor authentication using a security key
...
1.  Click on the "Register Key" button. You should see a prompt to choose the type of security key you would like to activate. The prompt will look different depending on your platform and browser. Select the security key type and activate it.
...
## Logging in with two-factor authentication using an authenticator application {#login}

When two-factor protection is enabled, if you would like to use an authenticator application to complete the second verification step, you must enter a verification code each time you log in with your username and password. To log in, enter your username and password and confirm.
...
## Logging in with two-factor authentication using a security key {#login}

When two-factor protection is enabled, if you would like to use a security key to complete the second verification step, you will need to activate your security key each time you log in with your username nad password. To log in, enter your username and password and confirm.

If the credentials are correct, you'll see a two-factor authentication window:

![Two-factor authentication](/files/2fa-login.png)

Click on the "Login" button, select the type of security key you will be activating, and activate the security key.
